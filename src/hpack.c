...
static struct h2get_buf h2get_header_authority = H2GET_BUFLIT(":authority");
static struct h2get_buf h2get_header_method = H2GET_BUFLIT(":method");
static struct h2get_buf h2get_header_method_get = H2GET_BUFLIT("get");
static struct h2get_buf h2get_header_method_post = H2GET_BUFLIT("post");
static struct h2get_buf h2get_header_path = H2GET_BUFLIT(":path");
static struct h2get_buf h2get_header_path_slash = H2GET_BUFLIT("/");
static struct h2get_buf h2get_header_path_index_html = H2GET_BUFLIT("/index.html");
static struct h2get_buf h2get_header_scheme = H2GET_BUFLIT(":scheme");
static struct h2get_buf h2get_header_scheme_http = H2GET_BUFLIT("http");
static struct h2get_buf h2get_header_scheme_https = H2GET_BUFLIT("https");
static struct h2get_buf h2get_header_status = H2GET_BUFLIT(":status");
static struct h2get_buf h2get_header_status_200 = H2GET_BUFLIT("200");
static struct h2get_buf h2get_header_status_204 = H2GET_BUFLIT("204");
static struct h2get_buf h2get_header_status_206 = H2GET_BUFLIT("206");
static struct h2get_buf h2get_header_status_304 = H2GET_BUFLIT("304");
static struct h2get_buf h2get_header_status_400 = H2GET_BUFLIT("400");
static struct h2get_buf h2get_header_status_404 = H2GET_BUFLIT("404");
static struct h2get_buf h2get_header_status_500 = H2GET_BUFLIT("500");
static struct h2get_buf h2get_header_accept_charset = H2GET_BUFLIT("accept-charset");
static struct h2get_buf h2get_header_accept_encoding = H2GET_BUFLIT("accept-encoding");
static struct h2get_buf h2get_header_accept_encoding_gzip_deflate = H2GET_BUFLIT("accept-encoding-gzip-deflate");
static struct h2get_buf h2get_header_accept_language = H2GET_BUFLIT("accept-language");
static struct h2get_buf h2get_header_accept_ranges = H2GET_BUFLIT("accept-ranges");
static struct h2get_buf h2get_header_accept = H2GET_BUFLIT("accept");
static struct h2get_buf h2get_header_access_control_allow_origin = H2GET_BUFLIT("access-control-allow-origin");
static struct h2get_buf h2get_header_age = H2GET_BUFLIT("age");
static struct h2get_buf h2get_header_allow = H2GET_BUFLIT("allow");
static struct h2get_buf h2get_header_authorization = H2GET_BUFLIT("authorization");
static struct h2get_buf h2get_header_cache_control = H2GET_BUFLIT("cache-control");
static struct h2get_buf h2get_header_content_disposition = H2GET_BUFLIT("content-disposition");
static struct h2get_buf h2get_header_content_encoding = H2GET_BUFLIT("content-encoding");
static struct h2get_buf h2get_header_content_language = H2GET_BUFLIT("content-language");
static struct h2get_buf h2get_header_content_length = H2GET_BUFLIT("content-length");
static struct h2get_buf h2get_header_content_location = H2GET_BUFLIT("content-location");
static struct h2get_buf h2get_header_content_range = H2GET_BUFLIT("content-range");
static struct h2get_buf h2get_header_content_type = H2GET_BUFLIT("content-type");
static struct h2get_buf h2get_header_cookie = H2GET_BUFLIT("cookie");
static struct h2get_buf h2get_header_date = H2GET_BUFLIT("date");
static struct h2get_buf h2get_header_etag = H2GET_BUFLIT("etag");
static struct h2get_buf h2get_header_expect = H2GET_BUFLIT("expect");
static struct h2get_buf h2get_header_expires = H2GET_BUFLIT("expires");
static struct h2get_buf h2get_header_from = H2GET_BUFLIT("from");
static struct h2get_buf h2get_header_host = H2GET_BUFLIT("host");
static struct h2get_buf h2get_header_if_match = H2GET_BUFLIT("if-match");
static struct h2get_buf h2get_header_if_modified_since = H2GET_BUFLIT("if-modified-since");
static struct h2get_buf h2get_header_if_none_match = H2GET_BUFLIT("if-none-match");
static struct h2get_buf h2get_header_if_range = H2GET_BUFLIT("if-range");
static struct h2get_buf h2get_header_if_unmodified_since = H2GET_BUFLIT("if-unmodified-since");
static struct h2get_buf h2get_header_last_modified = H2GET_BUFLIT("last-modified");
static struct h2get_buf h2get_header_link = H2GET_BUFLIT("link");
static struct h2get_buf h2get_header_location = H2GET_BUFLIT("location");
static struct h2get_buf h2get_header_max_forwards = H2GET_BUFLIT("max-forwards");
static struct h2get_buf h2get_header_proxy_authenticate = H2GET_BUFLIT("proxy-authenticate");
static struct h2get_buf h2get_header_proxy_authorization = H2GET_BUFLIT("proxy-authorization");
static struct h2get_buf h2get_header_range = H2GET_BUFLIT("range");
static struct h2get_buf h2get_header_referer = H2GET_BUFLIT("referer");
static struct h2get_buf h2get_header_refresh = H2GET_BUFLIT("refresh");
static struct h2get_buf h2get_header_retry_after = H2GET_BUFLIT("retry-after");
static struct h2get_buf h2get_header_server = H2GET_BUFLIT("server");
static struct h2get_buf h2get_header_set_cookie = H2GET_BUFLIT("set-cookie");
static struct h2get_buf h2get_header_strict_transport_security = H2GET_BUFLIT("strict-transport-security");
static struct h2get_buf h2get_header_transfer_encoding = H2GET_BUFLIT("transfer-encoding");
static struct h2get_buf h2get_header_user_agent = H2GET_BUFLIT("user-agent");
static struct h2get_buf h2get_header_vary = H2GET_BUFLIT("vary");
static struct h2get_buf h2get_header_via = H2GET_BUFLIT("via");
static struct h2get_buf h2get_header_www_authenticate = H2GET_BUFLIT("www-authenticate");
