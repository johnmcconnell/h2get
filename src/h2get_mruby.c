...
static mrb_value h2get_mruby_send_priority(mrb_state *mrb, mrb_value self)
{
    ...
    prio.exclusive = (int)mrb_exclusive;
    prio.dep_stream_id = (htonl(mrb_dep_stream_id) >> 1);
...
static mrb_value h2get_mruby_priority_init(mrb_state *mrb, mrb_value self)
{
    ...
    h2p->prio.dep_stream_id = (htonl(mrb_dep_stream_id) >> 1);
    h2p->prio.exclusive = (int)mrb_exclusive;
